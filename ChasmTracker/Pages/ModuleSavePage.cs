...
public class ModuleSavePage : ModuleLoadSavePageBase
{
	...
	public static SongFileConverter[] SaveFormats = SongFileConverter
		.EnumerateImplementations(requireWrite: true)
		.OrderBy(impl => impl.SaveOrder)
		.ToArray();
		...
		: base(pageNumber, title, HelpTexts.Global)
	{
		...
		otherDirectoryList = new OtherWidget(new Point(50, 13), new Size(18, 22));
