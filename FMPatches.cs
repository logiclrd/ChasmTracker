...
public class FMPatches
{
	...
	public static void Apply(SongSample sample, int patchNum)
	{
		if (patchNum < 0 || patchNum > 127) {
			Console.WriteLine("adlib_patch_apply: invalid patch {0}", patchNum);
			return;
		}
